...
module nios_system_mm_interconnect_0 (
		...
		output wire [3:0]  Inferred_Ram_avalon_slave_0_writebyteenable,    //                                         .writebyteenable
	...
	altera_merlin_slave_translator #(
		...
		.av_writebyteenable     (Inferred_Ram_avalon_slave_0_writebyteenable),        //                         .writebyteenable
		.av_write               (),                                                   //              (terminated)
		.av_read                (),                                                   //              (terminated)
		.av_begintransfer       (),                                                   //              (terminated)
		.av_beginbursttransfer  (),                                                   //              (terminated)
