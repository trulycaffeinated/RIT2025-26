...
readdata(7 downto 0) <= RAM_0(conv_integer(read_addr));
readdata(15 downto 8) <= RAM_1(conv_integer(read_addr));
readdata(23 downto 16) <= RAM_2(conv_integer(read_addr));
readdata(31 downto 24) <= RAM_3(conv_integer(read_addr));
